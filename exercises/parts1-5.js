...
// console.log(`${spacecraftName} would take ${getDaysToLocation(kilometersToMoon)} days to get to the Moon.`);
...
// console.log(`${spaceShuttle.name} would take ${spaceShuttle.getDaysToLocation(kilometersToMoon)} days to get to the Moon.`);
